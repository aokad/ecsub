...
class Aws_ecsub_control:
    ...
    def __init__(self, params, task_num):
        ...
        self.pre_command = params["pre_command"]
        if self.pre_command == "":
            self.pre_command = "apt update; apt install -y python-pip; pip install awscli --upgrade; aws configure list; "
            ...
            "containerDefinitions": [
                {
                    ...
                    "essential": True,
                      ...
                      "command": [
                          self.pre_command + "aws s3 cp " + option + self.s3_runsh + " /run.sh; " + self.shell + " /run.sh"
                      ],
                      "environment": [
                          {
